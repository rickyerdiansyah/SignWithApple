...
struct Keychain {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try Keychain(service: "com.rickyerdiansyah.SignWithApple", account: "Ricky Erdiansya").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try Keychain(service: "com.rickyerdiansyah.SignWithApple", account: "Ricky Erdiansya").deleteItem()
        } catch {
